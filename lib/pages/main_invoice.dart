//import other screens (notifcation....etc)

//import invoice_all soon
...
//تحليل بسيط للميزانية يعتبر ملخص شهري للمصرفات خلال الشهر الماضي
  // For demonstration, we’ll just store daily values to simulate the bar chart
  final List<Map<String, dynamic>> _summaryData = [
    {'day': 'Feb27', 'value': 70.0},
    {'day': 'Feb28', 'value': 120.0},
    {'day': 'Feb29', 'value': 90.0},
    {'day': 'Feb30', 'value': 60.0},
    {'day': 'Feb31', 'value': 150.0},
  ];
              ...
              Row(
                ...
                children: [
                  ...
                  GestureDetector(
                    ...
                    child: const Text(
                      'See All', // navigate to invoices list
                      style: TextStyle(color: Colors.grey),
                    ),
                  ),
                ],
